...
{
    resize(710, 540);
    setWindowTitle(tr("Gixelycoin Core") + " - " + tr("Wallet"));
#ifndef Q_OS_MAC
    qApp->setWindowIcon(QIcon(":icons/gixelycoin"));
    setWindowIcon(QIcon(":icons/gixelycoin"));
#else
...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send coins to a Gixelycoin address"));
    ...
    aboutAction = new QAction(QIcon(":/icons/gixelycoin"), tr("&About Gixelycoin"), this);
    aboutAction->setToolTip(tr("Show information about Gixelycoin"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(QIcon(":/trolltech/qmessagebox/images/qtlogo-64.png"), tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for Gixelycoin"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/gixelycoin"), tr("&Show / Hide"), this);
...
#ifndef Q_OS_MAC
            qApp->setWindowIcon(QIcon(":icons/gixelycoin_testnet"));
            setWindowIcon(QIcon(":icons/gixelycoin_testnet"));
#else
            MacDockIconHandler::instance()->setIcon(QIcon(":icons/gixelycoin_testnet"));
#endif
            if(trayIcon)
            {
                trayIcon->setToolTip(tr("Gixelycoin client") + QString(" ") + tr("[testnet]"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("Gixelycoin client"));
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Gixelycoin network", "", count));
}
...
{
    QString strTitle = tr("Gixelycoin") + " - ";
...
void BitcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
        ...
        if (nValidUrisFound)
            ...
            notificator->notify(Notificator::Warning, tr("URI handling"), tr("URI can not be parsed! This can be caused by an invalid Gixelycoin address or malformed URI parameters."));
    }
