...
#if defined(NDEBUG)
# error "Gixelycoin cannot be compiled without assertions."
#endif
...
const string strMessageMagic = "Gixelycoin Signed Message:\n";
...
#ifdef ENABLE_WALLET
// gixelycoin: attempt to generate suitable proof-of-stake
...
{
    RenameThread("gixelycoin-loadblk");
