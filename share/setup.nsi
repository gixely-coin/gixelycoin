...
!define URL http://www.gixelycoin.ru/

# MUI Symbol Definitions
!define MUI_ICON "../share/pixmaps/gixelycoin.ico"
...
#!define MUI_FINISHPAGE_RUN $INSTDIR\gixelycoin-qt.exe
...
OutFile gixelycoin-0.3.0-win32-setup.exe
...
Section -Main SEC0000
    SetOutPath $INSTDIR
    SetOverwrite on
    #File ../release/gixelycoin-qt.exe
    File /oname=license.txt ../COPYING
    File /oname=readme.txt ../doc/README_windows.txt
    SetOutPath $INSTDIR\daemon
    File ../src/gixelycoind.exe
    ...
    #Delete /REBOOTOK $INSTDIR\gixelycoin.exe
...
Section /o -un.Main UNSEC0000
    #Delete /REBOOTOK $INSTDIR\gixelycoin-qt.exe
